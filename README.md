<h1 align="center"><strong>FineXtrol: Controllable Motion Generation via Fine-Grained Text</strong></h1>
  <p align="center">
    <a href='#' target='_blank'>Keming Shen</a><sup>1,2</sup>&emsp;
    <a href='#' target='_blank'>Bizhu Wu</a><sup>1,2,3</sup>&emsp;
    <a href='#' target='_blank'>Junliang Chen</a><sup>4</sup>&emsp;
    <a href='#' target='_blank'>Xiaoqin Wang</a><sup>1,2</sup>&emsp;
    <a href='#' target='_blank'>Linlin Shen</a>*<sup>1,2,5</sup>&emsp;
    <br>
