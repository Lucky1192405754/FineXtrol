...
def main():
    ...
    is_using_data = args.text_prompt == ''

    # print(f"max_frames: {max_frames}")
    # print(f"fps: {fps}")
    # print(f"n_frames: {n_frames}")
    print(f"is_using_data: {is_using_data}")
    ...
    if is_using_data:
        ...
        detailed_texts = [args.detailed_text_prompt] * args.num_samples
    ...
    for rep_i in range(args.num_repetitions):
        ...
        # print("unconstrained:", args.unconstrained) # false
        ...
        if args.unconstrained:
            ...
            if 'detailed_text' in model_kwargs['y']:
                all_detailed_text += model_kwargs['y']['detailed_text']
            if 'hint' in model_kwargs['y']:
                print("================Enter hint process!================")
                hint = model_kwargs['y']['hint']
                # denormalize hint
                if args.dataset in ['humanml', 'detailed_text']:
    ...
    all_detailed_text = all_detailed_text[:total_num_samples]
    ...
    np.save(npy_path,
            {'motion': all_motions, 'text': all_text, 'lengths': all_lengths, "detailed_text": all_detailed_text,
...
def load_dataset(args, max_frames, n_frames):
    data = get_dataset_loader(name=args.dataset,
                              ...
                              split='test',
                              hml_mode='train')
    if args.dataset in ['kit', 'humanml', 'detailed_text']:
